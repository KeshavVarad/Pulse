...
*Any Admin or Instructor of a school can make a Practical. This page is for making a Practical as an Admin.  For Instructors follow this: **[Making a Practical (Admin)](/user_guides/admin/make_practical/)***
...
![Navbar Make Practical](./navbar_make_practical.png)

1. **Upload your video**. Click *Choose File*, then select your video on your computer. Then click **Upload**.
>Video must be .mp4 format and less than 500mb

![Admin Make Practical](./make_practical.png)

1. Enter the **Name** of the Practical.
   
2. *(optional)* Enter the school/work email of a student into the **Students** box. 
   
   ![Upload Video](./add_student1.png)
   
   Then click **Add Student**. This will display that student's email below. 

   ![Upload Video](./add_student2.png)
...
3. Click **Create Practical**
   ![Upload Video](./create_practical.png)